...
const replacements = [
    ...
    { offset: 0x0054e58D, from: [0x2C, 0x01], to: [0x43, 0x46] }, //Decrease Turret initial Health to 198
    { offset: 0x0054e5A9, from: [0x2C, 0x01], to: [0x43, 0x46] }, //Decrease Turret max Health to 198    
    ...
    //Mech Properties    
    { offset: 0x006690B9, from: [0x00, 0x00, 0xAF, 0x43], to: [0x00, 0x00, 0x2F, 0x44] }, //Increase R_Pawn ThrusterVerticalSpeed to 700
